...
constexpr size_t kInputBufferSizeFor1080p = 16 * 1024 * 1024;  // 16MB
...
DecodeInterface::DecodeInterface(const std::string& name,
    ...
    if (levels.empty()) {
        ...
        case VideoCodec::HEVC:
            ...
            break;
        case VideoCodec::AV1:
            levels = {C2Config::LEVEL_AV1_2,   C2Config::LEVEL_AV1_2_1, C2Config::LEVEL_AV1_2_2,
...
uint32_t DecodeInterface::getOutputDelay(VideoCodec codec) {
    ...
    case VideoCodec::VP9:
        ...
        return 8;
    case VideoCodec::AV1:
        // Reference: TOTAL_REFS_PER_FRAME at
        // https://aomediacodec.github.io/av1-spec/#symbols-and-abbreviated-terms
        return 8;
    }
}
